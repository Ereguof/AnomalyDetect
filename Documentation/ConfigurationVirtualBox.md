...
2. Télécharger l’image ISO de Debian 13.1.0 AMD64 depuis le site officiel : https://www.debian.org
3. Créer 1 machine virtuelle Debian qui servira de modèle pour les 3 machines nécessaires :
   ...
   - Créer un disque dur virtuel de type VDI, dynamiquement alloué, avec une taille d’au moins 20 GB4
